...
//
// do {
//     userNumber = prompt ("Please input and odd number between s1 and 50.");
// } while (isNaN(parseFloat(userNumber)) || userNumber < 1 || userNumber > 50 || userNumber % 2 === 0) {
...
do {
    userNumber = parseFloat(prompt("Please input and odd number between 1 and 50."));
